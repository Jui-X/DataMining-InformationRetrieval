...
from keras.layers import Embedding, Bidirectional, Dropout, Dense, GRU
...
OUTPUT_PATH = "data/BGRU_output.csv"
MAX_WORDS_NUM = 20000
BATCH_SIZE = 32
DROPOUT_VALUE = 0.15
MAX_LEN = 20
...
def get_model():
    ...
    model.add(Bidirectional(GRU(64, activation="relu", dropout=DROPOUT_VALUE, recurrent_dropout=DROPOUT_VALUE)))
